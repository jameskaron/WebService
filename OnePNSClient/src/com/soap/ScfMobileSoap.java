 ...
 * 2015-10-21T16:41:54.760+08:00
 * Generated source version: 2.7.15
 * 
 */
@WebServiceClient(name = "ScfMobileSoap", 
                  wsdlLocation = "http://localhost:8080/OnePNSServer/services/soap?wsdl",
...
public class ScfMobileSoap extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/OnePNSServer/services/soap?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ScfMobileSoap.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/OnePNSServer/services/soap?wsdl");
        }
        WSDL_LOCATION = url;
    }
